...
st.markdown("""
<style>
    /* Hide Streamlit header, deploy button, menu, footer, and collapse control */
...
# Input section
with st.container():
    col1, col2, col3, col4, col5, col6 = st.columns([1.5, 1.1, 1.1, 1.4, 1.1, 1.2])
...
with m4:
    ...
    <div class="metric-card">
        ...
        <div class="metric-caption">{entity.get("level", "Strong Match")}</div>
    </div>
    """, unsafe_allow_html=True)
